package org.xcom.schema.quartz.starter;
...
public class XcomQuartzStarterApplication {


    public static void main(String[] args) throws UnknownHostException {
        ApplicationContext applicationContext = SpringApplication.run(XcomQuartzStarterApplication.class, args);
